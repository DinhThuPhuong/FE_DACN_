...
import { getProfile, getCompanyById, addCompanyInfo } from '../../components/API/apiService'; // Đảm bảo đường dẫn đúng
...
const Company = () => {
    ...
    const handleCreateCompany = async () => {
        ...
        try {
            ...
            const response = await addCompanyInfo(companyId, companyRequest, file);
                    ...
                    <div className="col">
                        <Card className="shadow">
                            <CardHeader className="bg-transparent">
                                <h3 className="mb-0">Cập nhật thông tin công ty</h3>
                            </CardHeader>
                            <CardBody>
